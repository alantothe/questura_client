  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-limagreen px-8 py-6 md:w-[450px] bg-gradient-to-b from-zinc-800 to-slate-900 flex-shrink-0"
            key={item.name}
          >
            <blockquote>
              <div
